...
//go:generate swagger generate server --target ../../app --name TesseractOcr --spec ../../../swagger.yaml --template-dir /Users/wilhelmwonigkeit/Documents/GitHub/direktiv-apps/tesseract-ocr/build/templates --principal interface{}

func configureFlags(api *operations.TesseractOcrAPI) {
...
func configureAPI(api *operations.TesseractOcrAPI) http.Handler {
